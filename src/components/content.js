    ...
    <div className="main">
          ...
          <div className="feeds-section">
            ...
            <table className="feedtable">
              <tbody>
                ...
                <tr className="backgray">
                  <td>
                    <i className="fa fa-laptop laptop"></i>
                  </td>
                  <td>CPU overload.</td>
                  <td>
                    <i>35 mins</i>
                ...
                <tr className="">
                  <td>
                    <i className="fa fa-share-alt share-alt"></i>
                  </td>
                  <td>New shares.</td>
                  <td>
                    <i>39 mins</i>
      ...
      <div className="statuscontainer">
        ...
        <div>
          <p>New Visitors</p>
          <div className="rate">
            <div className="bar1" style={{ width: '25%' }}>
              +25%
            </div>
          </div>
        </div>
        <div>
          <p>New Users</p>
          <div className="rate">
            <div className="bar2" style={{ width: '50%' }}>
              50%
            </div>
          </div>
        </div>
        <div>
          <p>Bounce Rate</p>
          <div className="rate">
            <div className="bar3" style={{ width: '75%' }}>
              75%
            </div>
          </div>
        </div>
      ...
      <div className="statuscontainer">
        ...
        <ul className="card"> {/*순서 없는 목록 */}
          ...
          <li className="cardpadding">
            <img src={avatar5} className="cardmargin" alt="User 2" />
            <span className="w3-xlarge">Jill</span>
          </li>
          <li className="cardpadding">
            <img src={avatar6} className="cardmargin" alt="User 3" />
      ...
      <div className="commentcontainer">
        ...
        <div className="row comment-row">
          <div className="center">
            <img className="circle" src={avatar3} alt="John" />
          </div>
          <div className="john">
            <h4>
              John <span className="johntext">Sep 29, 2014, 9:12 PM</span>
            </h4>
            <div className="pa">
        ...
        <div className="row comment-row">
          <div className="center">
            <img className="circle" src={avatar1} alt="Bo" />
          </div>
          <div className="john">
            <h4>
              Bo <span className="johntext">Sep 28, 2014, 10:15 PM</span>
            </h4>
            <div className="pa">
              Keep up the GREAT work! I am cheering for you!! Lorem ipsum dolor
              sit amet, consectetur adipiscing elit, sed do eiusmod tempor
